...
namespace Imperium.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        public ContactoesController(ImperiumContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Causa,Comentario,Correo")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Causa,Comentario,Correo")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
